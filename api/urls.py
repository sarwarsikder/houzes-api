...
# from.views import *
from api.views import power_trace_view, photos_view, scout_form_view, payment_gateway_view, microservice_endpoint_view, notifications_view, fcm_notification
