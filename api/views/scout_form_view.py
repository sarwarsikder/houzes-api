...
def create_property(request):
    ...
    try:
        ...
        property = Property(street=street,city=city,state=state,zip=zip,property_tags=property_tags,owner_info=owner_info,user_list=user_list)
        property.save()
...
def photo_multiple_upload(request,id):
    ...
    for image_data in images_data.values():
        ...
        file_path = "photos/property_photos/{}/{}/{}".format(str(user.id), property_id, str(time.time()).replace('.','_') + '.jpg')
        ...
        thumb_file_path = "photos/property_photos/{}/{}/{}".format(str(user.id), property_id,str(time.time()).replace('.','_') + '_thumb.jpg')
