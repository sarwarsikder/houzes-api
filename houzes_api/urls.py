...
from authorization.views.customConvertTokenView2 import CustomConvertTokenView2
...
urlpatterns = [
    ...
    url(r'^auth/convert-token-review/?$', CustomConvertTokenView2.as_view(), name="convert_token_review"),
